...
set(ENABLE_GTEST ON)
SET(GTEST_LIBRARIES optimized ${CMAKE_BINARY_DIR}/../lib/gtest.lib debug ${CMAKE_BINARY_DIR}/../lib/gtest.lib)
SET(GTEST_BOTH_LIBRARIES ${GTEST_LIBRARIES} optimized ${CMAKE_BINARY_DIR}/../lib/gtest_main.lib 
											debug ${CMAKE_BINARY_DIR}/../lib/gtest_main.lib)

SET(GMOCK_LIBRARY optimized ${CMAKE_BINARY_DIR}/../lib/gmock.lib debug ${CMAKE_BINARY_DIR}/../lib/gmock.lib)
SET(GMOCK_BOTH_LIBRARIES ${GMOCK_LIBRARY} optimized ${CMAKE_BINARY_DIR}/../lib/gmock_main.lib debug ${CMAKE_BINARY_DIR}/../lib/gmock_main.lib)
