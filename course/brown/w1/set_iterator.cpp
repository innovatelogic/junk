...
void TestDistribution() {
  ...
  // ?????±?????¡?µ?? ???????È?? ?±?¡???µ?????? ???µ ?????µ???? ?±???È???????? ?????????????? ???????È????
  // (unordered_set, unordered_map ?????????È?????Ä???? ?????????????µ ???????È?¡ ?±?¡???µ??????
  // ?? ???µ?¡?È?????¡? ?????É GCC ?? Clang, ???È?? ???µ?????????????É ???????µ?È ?±?¡???µ??????
  // ?????????????¡???? ???È???¦?????????? ???? ?????¡?????¡?????????? ?É?µ??-?×?Ä????? ???µ?? ?? ???????É ???µ?¡?È?????¡? ?????É)
  ...
  // ???? ?????¡?????????????µ???????? ?????¡???????????????? 0.95:
  //
  // ?µ???È?? ???????????¡???????? ?????µ?????? ++buckets[hasher(point) % num_buckets]
  // ???????¡?¦?µ?????µ ++buckets[dist(gen) % num_buckets], ???? ?? ???µ???????????????????? 95%
  // ASSERT ?????¦?µ ???????¡?±?????¡?µ?? ?Ä?????µ??????,
  //
  // ??.??. ?????¡?????????????¡ ?????????????¡ ???????±?È?????????µ?È?????? ???¡???????µ???µ?È?µ???¡ ???? chi^2
  // ?? ???????È???? ?????µ???µ???µ?? ???????±??????, ???¡???????? num_buckets - 1,
  // ?? 95 ??????? ?µ???????È?? ?????????? ???¡???????µ???µ?È?µ?????? ???¡???µ??:
