...
void TestAbsentParts() {
  // ÐœÐµÑ‚Ð¾Ð´Ñ‹ GetMethodStats Ð¸ GetUriStats Ð´Ð¾Ð»Ð¶Ð½Ñ‹ Ð²Ð¾Ð·Ð²Ñ€Ð°Ñ‰Ð°Ñ‚ÑŒ ÑÐ»Ð¾Ð²Ð°Ñ€Ð¸
  // Ñ Ð¿Ð¾Ð»Ð½Ñ‹Ð¼ Ð½Ð°Ð±Ð¾Ñ€Ð¾Ð¼ ÐºÐ»ÑŽÑ‡ÐµÐ¹, Ð´Ð°Ð¶Ðµ ÐµÑÐ»Ð¸ ÐºÐ°ÐºÐ¾Ð¹-Ñ‚Ð¾ Ð¸Ð· Ð½Ð¸Ñ… Ð½Ðµ Ð²ÑÑ‚Ñ€ÐµÑ‡Ð°Ð»ÑÑ
